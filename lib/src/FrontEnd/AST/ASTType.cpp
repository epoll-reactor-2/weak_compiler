...
const char *weak::ASTTypeToString(ASTType T) {
  ...
  case AST_VAR_DECL:
    return "AST_VAR_DECL";
  case AST_ARRAY_DECL:
    return "AST_ARRAY_DECL";
  case AST_STRUCT_DECL:
    return "AST_STRUCT_DECL";
  case AST_BREAK_STMT:
    return "AST_BREAK_STMT";
  case AST_CONTINUE_STMT:
    return "AST_CONTINUE_STMT";
  case AST_BINARY:
    return "AST_BINARY";
  case AST_PREFIX_UNARY:
    return "AST_PREFIX_UNARY";
  case AST_POSTFIX_UNARY:
    return "AST_POSTFIX_UNARY";
