...
/*
static void visit_ir_alloca(ir_node_t *ir);
static void visit_ir_imm(ir_node_t *ir);
static void visit_ir_sym(ir_node_t *ir);
static void visit_ir_store(ir_node_t *ir);
static void visit_ir_bin(ir_node_t *ir);
static void visit_ir_label(ir_node_t *ir);
static void visit_ir_jump(ir_node_t *ir);
static void visit_ir_cond(ir_node_t *ir);
static void visit_ir_ret(ir_node_t *ir);
static void visit_ir_member(ir_node_t *ir);
static void visit_ir_array_access(ir_node_t *ir);
static void visit_ir_type_decl(ir_node_t *ir); /// Store this in some internal state.
static void visit_ir_func_decl(ir_node_t *ir);
static void visit_ir_func_call(ir_node_t *ir);
*/
...
static void visit_ast_char(ast_node_t *ast) { (void) ast; }
static void visit_ast_num(ast_node_t *ast) { (void) ast; }
static void visit_ast_float(ast_node_t *ast) { (void) ast; }
static void visit_ast_string(ast_node_t *ast) { (void) ast; }
static void visit_ast_bool(ast_node_t *ast) { (void) ast; }
static void visit_ast_struct_decl(ast_node_t *ast) { (void) ast; }
static void visit_ast_break(ast_node_t *ast) { (void) ast; }
static void visit_ast_continue(ast_node_t *ast) { (void) ast; }
...
static void visit_ast_array_decl(ast_node_t *ast) { (void) ast; }
...
static void visit_ast_unary(ast_node_t *ast) { (void) ast; }
static void visit_ast_array_access(ast_node_t *ast) { (void) ast; }
static void visit_ast_member(ast_node_t *ast) { (void) ast; }
static void visit_ast_if(ast_node_t *ast) { (void) ast; }
static void visit_ast_for(ast_node_t *ast) { (void) ast; }
static void visit_ast_while(ast_node_t *ast) { (void) ast; }
static void visit_ast_do_while(ast_node_t *ast) { (void) ast; }
...
{
    if (!state->_8_bit.ah) { state->_8_bit.ah = 1; return "ah"; }
    if (!state->_8_bit.al) { state->_8_bit.al = 1; return "al"; }
    if (!state->_8_bit.bh) { state->_8_bit.bh = 1; return "bh"; }
    if (!state->_8_bit.bl) { state->_8_bit.bl = 1; return "bl"; }
    if (!state->_8_bit.ch) { state->_8_bit.ch = 1; return "ch"; }
    if (!state->_8_bit.cl) { state->_8_bit.cl = 1; return "cl"; }
    if (!state->_8_bit.dh) { state->_8_bit.dh = 1; return "dh"; }
    if (!state->_8_bit.dl) { state->_8_bit.dl = 1; return "dl"; }
    return NULL;
}
...
static void visit_ast_function_call(ast_node_t *ast) { (void) ast; }
