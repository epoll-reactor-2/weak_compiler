...
\begin{document}
	...
	\section{Analiza leksykalna}
		...
		Jednym ze sposobów na sprowadzanie kodu źródłowego do postaći listy tokenów jest
		UNIX'owe narzędzie lex. Przyjmuje ono zestaw reguł w postaći wyrażeń regularnych, według których
	...
	\section{Analiza syntaksyczna}
		...
		\subsection{Definicja}
			...
			do tego notacja Backus–Naur form (BNF). Pełny opis gramatyki pokazany jest w końcu pracy. Pokażemy
