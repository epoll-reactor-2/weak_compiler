...
int main() {
  ...
  SECTION(VoidReturn) {
    TestAST("void f() {\n"
            ...
            "CompoundStmt <line:0, col:0>\n"
            "  FunctionDecl <line:1, col:1>\n"
            "    FunctionDeclRetType <line:1, col:1> <VOID>\n"
            "    FunctionDeclName <line:1, col:1> f\n"
            "    FunctionDeclArgs <line:1, col:1>\n"
            "    FunctionDeclBody <line:1, col:1>\n"
  ...
  SECTION(NonVoidReturn) {
    TestAST("float f() {\n"
            ...
            "CompoundStmt <line:0, col:0>\n"
            "  FunctionDecl <line:1, col:1>\n"
            "    FunctionDeclRetType <line:1, col:1> <FLOAT>\n"
            "    FunctionDeclName <line:1, col:1> f\n"
            "    FunctionDeclArgs <line:1, col:1>\n"
            "    FunctionDeclBody <line:1, col:1>\n"
  ...
  SECTION(ReturnEmptyFunctionCall) {
    TestAST("int f() {\n"
            ...
            "            FunctionCallArgs <line:2, col:10>\n");
  }
  ...
  SECTION(FunctionEmptyPrototype) {
      TestAST("void f();",
              "CompoundStmt <line:0, col:0>\n"
              "  FunctionPrototype <line:1, col:1> f\n"
              "    FunctionPrototypeArgs <line:1, col:1>\n");
  }
  SECTION(FunctionPrototypeWithParameters) {
      TestAST("void f(int arg1, int arg2, float arg3, char arg4);",
              "CompoundStmt <line:0, col:0>\n"
              "  FunctionPrototype <line:1, col:1> f\n"
              "    FunctionPrototypeArgs <line:1, col:1>\n"
              "      VarDeclStmt <line:1, col:8> <INT> arg1\n"
              "      VarDeclStmt <line:1, col:18> <INT> arg2\n"
              "      VarDeclStmt <line:1, col:28> <FLOAT> arg3\n"
              "      VarDeclStmt <line:1, col:40> <CHAR> arg4\n");
  }
  SECTION(ReturnFunctionCallExpression) {
      TestAST("int f() {"
              ...
              "              FunctionCallArgs <line:1, col:23>\n"
